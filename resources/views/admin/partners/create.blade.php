    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.partners.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_title_en') ? 'is-invalid' : '' }}" type="text" name="job_title_en" id="job_title_en" value="{{ old('job_title_en', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_title_ar') ? 'is-invalid' : '' }}" type="text" name="job_title_ar" id="job_title_ar" value="{{ old('job_title_ar', '') }}" required>
